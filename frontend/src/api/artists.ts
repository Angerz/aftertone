...
import type { Artist, ArtistDetail, ArtistUpdate, PaginatedResponse } from "./types";
...
export const updateArtist = (id: number, payload: ArtistUpdate) => request<Artist>(`/api/artists/${id}`, { method: "PATCH", body: JSON.stringify(payload) });
