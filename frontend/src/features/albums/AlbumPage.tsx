...
export function AlbumPage({ albumId, onBack, onRate, onReconcile, onEdit }: { albumId: number; onBack: () => void; onRate: () => void; onReconcile: () => void; onEdit: () => void }) {
