...
export function AlbumsPage({ onCreate, onImport, onOpen }: { onCreate: () => void; onImport: () => void; onOpen: (id: number) => void }) {
  ...
  return <main className="page">
    <header className="masthead library-header"><div><p className="eyebrow">Aftertone</p><h1>Library</h1><p>Your collection of listened-to records.</p></div><div className="library-actions"><button className="text-button" onClick={onImport}>Import legacy ratings</button><button onClick={onCreate}>+ Add album</button></div></header>
