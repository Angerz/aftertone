...
export function AlbumsPage({ onCreate, onOpen }: { onCreate: () => void; onOpen: (id: number) => void }) {
  ...
  return <main className="page">
    <header className="masthead library-header"><div><p className="eyebrow">Aftertone</p><h1>Library</h1><p>Your collection of listened-to records.</p></div><button onClick={onCreate}>+ Add album</button></header>
