...
const album: Album = { id: 1, title: "Album", artists: [{ id: 1, name: "Artist" }], year: 2026, release_type: "album", created_at: "2026-01-01T00:00:00Z", tracks: [{ id: 10, position: 1, title: "Existing", primary_artists: [], featured_artists: [], uses_album_artists: true }, { id: 20, position: 2, title: "New track", primary_artists: [], featured_artists: [], uses_album_artists: true }], latest_revision: null, cover_url: null, needs_revisit: false, revisit_reason: null, revisit_marked_at: null, latest_legacy_rating: null };
