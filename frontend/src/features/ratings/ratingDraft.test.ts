...
const album: Album = { id: 1, title: "Album", artist: "Artist", year: 2026, release_type: "album", created_at: "2026-01-01T00:00:00Z", tracks: [{ id: 10, position: 1, title: "Existing" }, { id: 20, position: 2, title: "New track" }] };
